...
* Created several functions to extract useful information from model output (i.e., getFixEf(), getRanEf(), getCoef(), getVarCov(), getFitted(), getModelFit(), getClassProb(), getKProb()). 
