...
This package requires Just Another Gibbs Sampler (JAGS) to be installed on your computer (<https://mcmc-jags.sourceforge.io/>), and depends on the packages `rjags` and `label.switching`.
...
You can install the development version of BEND from [GitHub](https://github.com/) with:
...
or directly from the [CRAN](https://cran.r-project.org/) repository with:
